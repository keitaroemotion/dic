...
class Lib::UtilTest < Minitest::Test
  ...
  def test_md_image_link
   ...
   link_with_height = "![matrix.png](images/201771815003690881matrix.png.png 500)"
   assert_equal "<img src=images/201771815003690881matrix.png.png height=500/>", @util.md_image_link(link_with_height, root, shelf)
  end
